    ...
    <div className="flex justify-center h-screen place-items-center bg-gradient-to-l from-blue-950 to-purple-900">
      <div className={`flex flex-col gap-8 items-center bg-white rounded-md p-5 md:px-10`}>
        ...
        <div className="flex flex-col items-center gap-4">
          <input type="text" className="h-10 md:h-12 md:text-xl w-60 md:w-80 pl-1 border border-slate-400 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-md" placeholder="Nome" />
          ...
          <input type="text" className="h-10 md:h-12 md:text-xl w-60 md:w-80 pl-1 border border-slate-400 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-md" placeholder="Confirmar senha" />
        </div>
        <div className="bg-purple-950 cursor-pointer p-3 rounded-md text-white hover:bg-purple-900 transition duration-200">
          Cadastrar
        </div>
        <div>Já possui uma conta? <Link href="/entrar" className="text-purple-800 font-semibold">Entrar!</Link></div>
      </div>
    </div>
  );
}
