...
export default function Cofre() {
  return (
    <nav className="bg-white border-gray-200 drop-shadow-xl dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2">
          <div type="button" className="flex mr-3 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
            {/* <img className="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg" alt="user photo"> */}
            <span className="text-white px-3 py-1 rounded-full text-xl bg-violet-500">A</span>
          </div>
